 ...
 */
package com.zhongxin.ctsms.generate;
...
import com.zhongxin.ctsms.common.utils.FileUtils;
import com.zhongxin.ctsms.common.utils.FreeMarkers;
...
public class Generate {
	...
	public static void main(String[] args) throws Exception {
		...
		String packageName = "com.zhongxin.ctsms.modules";
		
		String moduleName = "coal";			// 模块名，例：sys
		String subModuleName = "";				// 子模块名（可选） 
		String className = "CoalPrice";			// 类名，例：user
		String classAuthor = "Yake";		// 类作者，例：ThinkGem
		String functionName = "煤价";			// 功能名，例：用户
		...
		String templatePath = classPath.replace(separator+"webapp"+separator+"WEB-INF"+separator+"classes",
				separator+"java"+separator+"com"+separator+"zhongxin"+separator+"ctsms"+separator+"modules");
		...
		model.put("functionName", new String(functionName.getBytes("UTF-8"),"GBK"));
