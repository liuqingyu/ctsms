...
<%@ taglib prefix="tags" uri="http://java.sun.com/jsp/jstl/fmt" %>--%>
...
<body>
    <ul class="nav nav-tabs">
        <li><a href="${ctx}/coal/contract/purchaseForm">采购合同录入</a></li>
        <%--<li class="active"><a href="${ctx}/coal/contract/purchaseForm?contractSid=${contract.contractSid}">合同<shiro:hasPermission name="coal:contract:edit">${not empty contract.contractSid?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="coal:contract:edit">查看</shiro:lacksPermission></a></li>--%>
    </ul><br/>
        ...
        <form>
            <fieldset>
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <div class="control-group">
                            <label class="control-label"><span style="color:#ff0000">*</span>合同类型 ：</label>
                            <div class="controls">
                    ...
                    <td colspan="2">
                        <div class="control-group">
                            <label class="control-label"><span style="color:#ff0000">*</span>签订日期 ：</label>
                            <div class="controls">
                ...
                <tr>
                    <td colspan="2">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input id="remarks" name="remarks" type="text" width="300" heigh="100" readonly="readonly" class="Wdate input-medium"
            ...
            <fieldset>
                ...
                <table id="contentTable0" class="table table-striped table-bordered table-condensed">
                    <thead>
                        <tr>
                            <th>序号</th>
                            <th><span style="color:#ff0000">*</span>煤种名称</th>
                            <th>发热量</th>
                            <th>开票煤价</th>
                            <th><span style="color:#ff0000">*</span>合同煤价</th>
                            <th>扣损率</th>
                            <th>签订吨数</th>
                            <th>签订金额</th>
                            <th>状态</th>
        ...
        <form>
            <fieldset>
                ...
                <tr>
                    ...
                    <input type="button" name="browserfile" value="浏览...">
                    <label class="control-label">文件名：</label>
                    <input type="text" name="fileName"><input type="button" name="browserfile" value="新增文件">
                </tr>
            </fieldset>
        </form>
    <%--</table>--%>
